...
class FloatApp(App):
    def build(self):
        ...
        l1 = Button(
            text="email", size_hint=(.15, .05),
            pos=(150, 350), color = [1,1,1,1]
        )

        flo.add_widget(l1)

        self.t1 = TextInput(size_hint=(.5, .05), pos=(290, 350))
        flo.add_widget(self.t1)

        l2 = Button(
            text="Senha", size_hint=(.15, .05),
            pos=(150, 250),color = [1,1,1,1]
        )

        flo.add_widget(l2)

        t2 = TextInput(
            multiline=True, size_hint=(.5, .05), pos=(290, 250)
        )
